<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" style="margin-top: 50px">
        ...
        <li class="{{ request()->is('jadwalCapaianTrainer','showKegiatan/*', 'detailInfo/*') ? 'active' : '' }}"><a href="/jadwalCapaianTrainer"><i class="fa fa-flag"></i> <span>Agenda & Capaian</span></a></li>
