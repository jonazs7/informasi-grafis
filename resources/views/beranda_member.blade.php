  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div style="margin-top: 8px;">
        <form action="{{ route('filterTanggal') }}" method="GET" class="form-inline">
          ...
          <a type="button" href="/beranda" class="btn btn-default" style="margin-top: 20px; margin-left: 8px; width: 56.2px; height: 34px;">
